...
==============================================================
Script Purpose:
    This stored procedured performs the ETL (Extract, Transform, Load) process to populate the 'silver' schema tables from the 'bronze' schema
...
exception	
	when others then 
		...
		raise exception '-> Failed to load Silver Layer';
		raise notice '==========================================================';
end;
$$;
